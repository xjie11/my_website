(function($) {
    ...
    var TIMING_CONSTANT = 200;
    var TIMING_CONSTANT_2 = 200;
    ...
    $.fn.init_workspaces = function() {
        ...
        $('body').keyup(function(e){
          var key = e.which;
          var index = parseInt($('.workspace.active').attr('id').slice(-1));
          switch (key){
            case 37:
            case 38:
            case 39:
    ...
    $.fn.transitionTo = function() {
        ...
        var activeIndex= parseInt($('.workspace.active').attr('id').slice(-1));
